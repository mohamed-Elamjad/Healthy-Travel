...
const Blogs = () => {
  return (
    ...
    <div className="flex items-center justify-between gap-20">
      <Header category="Page" title="List Blogs" />
      <Link to="">
        <button
          type="submit"
      ...
      <table className="min-w-full bg-white">
        ...
        <tbody className="whitespace-nowrap divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td className="p-4">Top places to visit in USA</td>
            <td className="p-4">
            ...
            <td className="p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni </td>
