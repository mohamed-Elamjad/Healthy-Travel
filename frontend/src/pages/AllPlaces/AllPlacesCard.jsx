...
const AllPlacesCard = ({img, title, location, description, price, rating }) => {
  return (
    <div className="shadow-lg transition-all mb-4 duration-500 hover:shadow-xl cursor-pointer h-[450px] flex flex-col">
