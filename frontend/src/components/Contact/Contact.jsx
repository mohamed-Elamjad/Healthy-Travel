const Contact = () => {
  return (
    <div id="Contact" className="font-[sans-serif] max-w-6xl  mx-auto relative bg-white rounded my-20">
            <div className="grid lg:grid-cols-3 items-center  px-[60px]">
                <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
                    <div 
                    data-aos="fade-up"
                    className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#008EC4]" viewBox="0 0 512 512">
                        ...
                        className="text-[#333] text-base font-extrabold mt-4">Visit office</h4>
                        <p className="text-sm tect-gray-400 mt-2"> 123 Main Street, City, Country</p>
                    </div>
                    <div 
                    data-aos="fade-up"
                    className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#008EC4]" viewBox="0 0 473.806 473.806">
                        ...
                        <p className="text-sm tect-gray-400 mt-2">+158 996 888</p>
                    </div>
                    <div 
                    data-aos="fade-up"
                    className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#008EC4]" viewBox="0 0 32 32">
                        ...
                        <p className="text-sm tect-gray-400 mt-2">info@example.com</p>
                    </div>
                    <div
                    data-aos="fade-up"
                    className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-[#008EC4]" viewBox="0 0 100 100">
                        ...
                        <p className="text-sm tect-gray-400 mt-2">+1-548-2588</p>
                    </div>
                </div>
                <div 
                data-aos="fade-up"
                className="lg:col-span-2 bg-[#008EC4] rounded sm:p-10 p-4 z-10">
